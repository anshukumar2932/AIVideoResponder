-- ============================================================================
-- Sample Test Data for Customer Support Chatbot
-- ============================================================================
...
(1, 'ORD-2024-001', 'Delivered', 299.99, CURRENT_TIMESTAMP - INTERVAL '5 days'),
(1, 'ORD-2024-002', 'Shipped', 149.50, CURRENT_TIMESTAMP - INTERVAL '2 days'),
(2, 'ORD-2024-003', 'Processing', 89.99, CURRENT_TIMESTAMP - INTERVAL '1 day'),
(3, 'ORD-2024-004', 'Delivered', 499.99, CURRENT_TIMESTAMP - INTERVAL '10 days'),
(4, 'ORD-2024-005', 'Cancelled', 199.99, CURRENT_TIMESTAMP - INTERVAL '3 days');

-- Insert Support Agents
INSERT INTO support_agents (agent_name, email, specialization, is_available) VALUES
('Sarah Johnson', 'sarah.j@support.com', 'Refunds', TRUE),
('Mike Chen', 'mike.c@support.com', 'Technical', TRUE),
('Emily Rodriguez', 'emily.r@support.com', 'Billing', TRUE);
...
(1, 1, 'Delivery', 'Late Delivery', 'Order not received on time', 
 ...
 TRUE, 85.50, 'Resolved', 'Medium', 'Neutral'),
...
VALUES
(CURRENT_DATE - INTERVAL '1 day', 15, 12, 3, 87.50, 8, 4.2),
(CURRENT_DATE, 5, 3, 2, 85.20, 10, 4.0);
